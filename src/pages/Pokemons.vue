    ...
    <div class="relative">
      ...
      >
        ...
        >
          ...
          <label class="p-2 cursor-pointer font-bold" for="pokemon_name"
          ...
          <input
            ...
            class="w-full px-2 py-1 bg-gradient-to-r from-purple-800 via-red-600 to-yellow-500 font-extrabold text-indigo-200"
          />
        </div>
